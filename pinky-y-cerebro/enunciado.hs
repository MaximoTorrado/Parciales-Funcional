{- En el laboratorio de la compañía ACME, científicos modifican genéticamente a animales para darles capacidades especiales. De estos experimentos surgieron, entre otros, Pinky y Cerebro, uno es un genio, y el otro no es 
tan cuerdo.  Para ayudar a los científicos en esta compleja tarea, nos han pedido que simulemos sus experimentos, resolviendo los siguientes problemas y explicitando el tipo de todas las funciones principales: 
...
noTanCuerdo: si tiene más de dos habilidades de hacer sonidos pinkiescos. Hacer una  función pinkiesco, que significa que la habilidad empieza con “hacer ”, y luego va seguido de una palabra "pinkiesca", es decir, con 4 
letras o menos y al menos una vocal. Ejemplo:
...
"En un ratón de coeficiente intelectual 17, con habilidades de destruenglonir el mundo y hacer planes desalmados, hacer un experimento que consista en pinkificarlo, luego darle inteligencia superior de 10 y por último darle
superpoderes. Como criterio de éxito, ver si quedó antropomórfico" 

5. Periódicamente, ACME pide informes sobre los experimentos realizados. Desarrollar los siguientes reportes, que a partir de una lista de animales, una lista de capacidades y un experimento (o una serie de transformaciones)
permitan obtener:
