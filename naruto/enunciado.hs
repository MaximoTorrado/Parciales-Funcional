...
De cada una conocemos el nombre y la cantidad disponible. Algunos ejemplos son: bombas de
...
● NO repetir lógica.
● Se espera que se demuestre dominio de orden superior, composición y aplicación
parcial, siendo usados donde corresponda.

● Recomendamos enviar la solución a GitHub cada 30 minutos o a medida que vayas
resolviendo cada punto por si llega a haber algún inconveniente con la computadora
o internet.  -}