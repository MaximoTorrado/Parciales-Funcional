{- ¿Tenés un perrito y te toca ir a la oficina durante el día? ¿Te vas de vacaciones y no tenés con quien dejarlo? ¡No te preocupes! "P de Perritos”, la guardería perruna, abrió sus puertas para que puedas dejar a tu fiel 
compañero en sus buenas manos. ¡Ayudala a dar un excelente servicio con tus conocimientos del paradigma funcional!
...
De las guarderías sabemos que tienen un nombre y una rutina para entretener a los pichichos. La rutina es un conjunto de actividades, compuestas por el ejercicio y el tiempo que éste dura en minutos. Algunos de estos
ejercicios son:
...
Y entonces… ¿cuándo abreeeeeee? ✋Primero debemos asegurarnos de:
 ...
 Que un perro realice una rutina de la guardería (que realice todos sus ejercicios). Para eso, el tiempo de la rutina no puede ser mayor al tiempo de permanencia. En caso de que esta condición no se cumpla, el perro no hace
 nada. 🐕
